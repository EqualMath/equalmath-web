                  ...
                  <div className="timeline-container">
                    ...
                    >
                      ...
                      <li>
                        ...
                        <p className="text-black">
                          Each tutor has a Google Appointments page. Select a
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          Sessions typically last 30 minutes. If you&apos;d
                          like, you can book two sessions back-to-back to have
                          an hour-long session. Please do not book more than two
                          sessions in one day.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          ...
                          Reach out (see bottom of page) and we&apos;ll do our
                          best to connect you with a tutor or other resources.
                        </div>
                      </div>
                    </div>
